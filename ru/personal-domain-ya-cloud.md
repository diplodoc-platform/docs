...
1. В результате успешного выполнения пошаговой инструкции вы получите сообщение:
    ...
    Идентификатор ключа:
    YCAJEmFaBcTmNBXxg1M7qSa****
    Секретный ключ:
    YCO6ctaYJxgdcVs1g3c5qOaq***
...
1. Заполните поле **Спецификация**: используйте свою OpenAPI спецификацию или пример.
    ...
    1. Найдите параметр `x-docs-proxy-base` и измените значение на `' '`.
    1. Найдите параметр `paths:` и  удалите значение `/путь` из параметра. Значение должно стать таким: `/{path+}:`.
