...
Базовый проект состоит из [конфигурационного файла .yfm](./settings.md#config), [разводящей страницы](./project/leading-page.md) и страниц с контентом, связанных между собой [файлом оглавления toc.yaml](./project/toc.md).
