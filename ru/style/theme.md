...
Управлять темой документации можно с помощью конфигурационного файла `theme.yaml` в корне проекта, при сборке с помощью флага `--theme` или в корневой секции `.yfm`.

## Определение темы в файле конфигурации {#config}

### Структура файла {#config-structure}
...
### Параметр base-brand {#base-brand}
...
Если одновременно заданы и настройка в `.yfm`, и флаг `--theme`, то флаг будет приоритетнее.
