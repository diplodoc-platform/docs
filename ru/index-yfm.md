...
* расширяемый: можно [подключить](./plugins/external.md) любой плагин для markdown-it или [написать свой](https://github.com/markdown-it/markdown-it/tree/master/docs);
