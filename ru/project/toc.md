...
## Миниток на странице документации (Minitoc)

{% note warning %}

Заголовки первого уровня зарезервированы в качестве заголовка статьи и на них действуют следующие правила:

- Заголовки первого уровня не попадают в миниток.
- На заголовки первого уровня не получится повесить якорь.

{% endnote %}

Миниток не появится, если пропущен один из уровней заголовков.
