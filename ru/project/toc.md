...
Заголовки первого уровня зарезервированы в качестве заголовка статьи, они не попадают в миниток и на них не получится повесить якорь.

{% endnote %}

Если пропущен один из уровней заголовков, то миниток не появится.
