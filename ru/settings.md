...
Для генерации pdf-версии документации необходимо использовать сервис `@diplodoc/pdf-generator` [согласно инструкции](https://github.com/diplodoc-platform/pdf-generator). Секция содержит параметры предобработки данных для работы сервиса.
