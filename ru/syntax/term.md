...
Содержимое всплывающих подсказок можно поместить в отдельный файл. Для этого поместите содержимое подсказки под заголовок четвертого уровня. Заголовок оформите в виде [якоря](base.md#anchor).

Подключите текст всплывающей, применив [`include`](../project/includes.md).
