...
Если видеохостинг не поддерживается, но у вас есть плеер, который можно встроить в документацию, воспользуйтесь разделом [Видео из неподдерживаемого видеохостинга](#personal-player).
...
### Видео из неподдерживаемого видеохостинга {#personal-player}
