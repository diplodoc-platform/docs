...
Если ваш видеохостинг не поддерживается, но есть плеер, который можно встроить в документацию, воспользуйтесь разделом [Плеер из неподдерживаемого видеохостинга](#personal-player).
...
Если видеохостинг не поддерживается, но у вас есть плеер, который можно встроить в документацию.

1. Чтобы добавить на страницу видео, используйте разметку:

    ```markdown
    @[](id-видео-или-ссылка-на-него)
    ```
