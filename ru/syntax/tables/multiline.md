...
Для установки пользовательской ширины ячейки используйте синтаксис `{width=400px}`, где `400` — значение в пикселях. 
...
Для установки пользовательской ширины ячейки используйте синтаксис `{height=200px}`, где `200` — значение в пикселях. 
