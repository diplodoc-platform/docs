...
- Ширина ячейки
  ...
  Для установки пользовательской ширины ячейки используйте синтаксис `{width=400px}` внутри ячейки, где `400` — значение в пикселях. 
...
- Высота ячейки
  ...
  Для установки пользовательской высоты ячейки используйте синтаксис `{height=100px}` внутри ячейки, где `100` — значение в пикселях.
