...
Пример таблицы с атрибутами всех трёх уровней:

```markdown
#|
|:{header-rows="1"}
||:{class="row"} ::{align="center"} Заголовок1 | Заголовок2 | Заголовок3 ||
||::{align="top-left"} Текст | Текст |::{align="top-right"} Текст ||
|| Текст | Текст | Текст ||
|#
```
...
### Атрибуты строки {#row-attributes}
...
### Атрибуты ячейки {#cell-attributes}
...
Подробнее про доступные атрибуты ячейки см. раздел [Выравнивание текста в ячейках](#cell-align).
