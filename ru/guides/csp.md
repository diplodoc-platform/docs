...
Если CSP управляется внешним образом (например, через HTTP-заголовки сервера), можно полностью отключить добавление мета-тега CSP при сборке с помощью параметра `disableCsp`:
