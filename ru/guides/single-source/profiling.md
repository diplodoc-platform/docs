...
Cоздайте [файл `presets.yaml`](presets.md). Общий файл располагается в корневой директории проекта и содержит все переменные для каждого условия профилирования.
...
Конфигурационный файл `a.yaml` содержит настройки деплоя. Деплой настраивается отдельно для каждого документа.
