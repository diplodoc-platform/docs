...
**Переиспользование** контента позволяет подставлять повторяющиеся фрагменты текста внутри одного или нескольких документов0. 

  Способ применяется, если уникального контента больше, чем общего!.

  Переиспользование обеспечивают ХХХ:
