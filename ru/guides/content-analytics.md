...
Контентная аналитика, основанная на данных, помогает понять, как пользователи взаимодействуют с вашими материалами и какие улучшения необходимы. Яндекс Метрика позволяет анализировать и оптимизировать техническую документацию. В этой статье мы рассмотрим, как интегрировать контентную аналитику Яндекс Метрики в работу с документацией.
...
Разметка задаётся в [метаданных](../project/meta.md) файлов документации с расширением `md`.
