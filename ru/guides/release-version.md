...
Версионирование позволяет управлять различными наборами документации для разных версий проекта. Функция обеспечивает публикацию документации для новых версий с сохранением доступа к старой документации.
