...
Больше информации о параметрах и конфигурации в разделе [**Документационный проект**](./project/index.md). 

### Локальная сборка проекта 

Сборка выполняется с помощью инструмента [**yfm**](tools/docs/index.md) в командной строке.
...
Готовые проекты в HTML можно использовать локально или разместить на хостинге, включая S3-like.
