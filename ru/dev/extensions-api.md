...
- [Leading Service](./extensions/services/leading-service.md) — обработка разводящих страниц.
...
- [VCS Service](./extensions/services/vcs-service.md) — работа с системой контроля версий.
- [Search Service](./extensions/services/search-service.md) — организация поиска по документации.
- [Logger Service](./extensions/services/logger-service.md) — управление логгированием.
