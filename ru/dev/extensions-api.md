...
- **Hook-based Architecture**: Система hooks для расширения функциональности на различных этапах процесса сборки документации
- **Type Safety**: Полная поддержка TypeScript с подробными определениями типов
- **Modular Design**: Создание независимых, переиспользуемых extensions
