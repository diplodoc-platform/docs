...
Если вы хотите быстро приступить к разработке, воспользуйтесь [кратким руководством](https://github.com/diplodoc-platform/diplodoc/blob/master/DEVELOPMENT.md) в корневом репозитории.
...
Самый простой способ начать разработку любого модуля в системе - запустить преднастроенный GitHub Codespace в соответствующем репозитории.
