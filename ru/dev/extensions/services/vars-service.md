...
Vars Service отвечает за управление переменными в Diplodoc. Этот сервис позволяет работать с [пресетами переменных](../../../project/presets.md), определенными в файлах `presets.yaml`, и применять их к документации.
